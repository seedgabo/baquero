...
export class TicketPage {
    ...
    loading: string = "";
    datos: boolean = false;
    constructor(public platform: Platform, public navCtrl: NavController, public transfer: Transfer, public inappbrowser: InAppBrowser,
        params: NavParams, api: Api, public modal: ModalController, public toast: ToastController, public alert: AlertController) {
        this.api = api;
